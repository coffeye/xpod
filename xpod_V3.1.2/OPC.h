...
OPC.h - library for operating optical particle counter OPC-R2 from Alphasense using an Arduino Mega.
 ...
 Written by Joseph Habeck (habec021@umn.edu) on 6/24/18. (https://github.com/JHabeck/Alphasense-OPC-N2/tre/master)
...
#define PRINT_BINS  1 // Prints the amount of particles in each of the 16 bins
